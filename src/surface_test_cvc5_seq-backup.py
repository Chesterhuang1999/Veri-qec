...
@timebudget
def smtencoding(precond, program, postcond, err_cond, err_gt, decoder_cond, bit_width, err_val):
    ...
    formula_to_check = And(substitution, Or(Not(err_expr), decoding_formula))
...
def partition_checker(distance, encode_time, check_time):
    pass
